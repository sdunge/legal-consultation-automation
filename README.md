...
193건으로 2위 코인사기(128건)보다 1.5배 많음.  
홍보 콘텐츠를 리딩사기 피해 예방에 집중 시 유입 효율 극대화 가능.

**② 온라인 채널이 전체 60% 차지**  
홈페이지(154건) + SNS(100건) = 254건으로 오프라인(173건) 초과.  
디지털 마케팅 강화가 상담 접수 증대에 유효함을 시사.

**③ 2월 피크, 4월 급감 — 계절성 패턴 발견**  
2월 74건(연중 최고) → 4월 19건(연중 최저).  
설 연휴 이후 사기 피해 신고 집중 패턴으로 해석,  
2월 전후 홍보 강화 전략 수립에 활용 가능.
